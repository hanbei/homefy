...
class TestSearcher(unittest.TestCase):
	...
	def setUp(self):
		...
		indexer.add_album(model.Album(title=u'TestAlbum', picture_path=u"test/tset/test.jpg", artist=u'ArtistTest', year=2002))
		indexer.add_album(model.Album(title=u'TestAlbum2', picture_path=u"test/tset/test2.jpg", artist=u'ArtistTest', year=2004))
		indexer.add_track(model.Track(title=u'TitleBla', artist=u'ArtistTest', album=u'TestAlbum', path='path1', track_no=2))
		indexer.add_track(model.Track(title=u'TitleBla2', artist=u'ArtistTest', album=u'TestAlbum', path='path2',track_no=3))
		indexer.add_track(model.Track(title=u'TitleBla3', artist=u'ArtistTest', album=u'TestAlbum', path='path3',track_no=4))
		indexer.commit()
